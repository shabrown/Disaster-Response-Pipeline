...
def load_data(database_filepath):
    ...
    Returns:
    X(dataframe): A dataframe of the feature variable
    Y(dataframe): A dataframe of the target variables
...
def evaluate_model(model, X_test, Y_test, category_names):
    ...
    Args:
    model: trained model returned from build_model function
    X_test(list): Feature for testing
    Y_test(list): Target for testing
